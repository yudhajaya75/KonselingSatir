        ...
        <div className='navbar'>
            ...
            <ul className='listnav'>
                ...
                <div>
                    <Link to='/layanan' className='teksnav1' style={{ color: '#4B4B4B' }}>
                        <li>layanan</li> <li style={{ marginLeft: 10 }}>
                            {isOpen ? (
                                <AiOutlineCaretDown />
                            ) : (
                                <AiOutlineCaretUp />
                ...
                <Link to="/blog">
                    <li className='teksnav2' style={{ color: '#074288', fontWeight: 'bold', fontSize: '20px' }}>Blog</li>
                </Link>
                <Link to="/about">
            ...
            <div className={nav ? 'nav' : 'fixed left-[-100%]'}>
                ...
                <ul className='uppercase p-4'>
                    ...
                    <div className='mt-10'>
                        <Link to='/login' className='bg-[#00df9a] hover:bg-[#00c78d] text-white font-bold py-2 px-20 rounded mt-20'>
                            Login
                        </Link>
                    </div>
                </ul>
